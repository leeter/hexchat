...
GtkWidget *mg_create_generic_tab (char *name, char *title, int force_toplevel, int link_buttons, GCallback close_callback, void *userdata, int width, int height, GtkWidget **vbox_ret, void *family);
